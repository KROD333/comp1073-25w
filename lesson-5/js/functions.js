...
let text = "Functions are not awesome.";
let newText = text.replace("not", "totally");
console.log(newText);
...
let functionText = "My random number is X."; // X will be replaced by the random number
let newFunctionText = functionText.replace("X", random);
console.log(newFunctionText);

// Parameters optional

let lunchArray = ["spicy", "chicken", "curry"];
