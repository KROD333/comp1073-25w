...
output.textContent = `The second element within fourth element in myArray is ${myArray[3][1]}.`;
...
output.textContent = `There are ${myArray[3].Length} items in the array inside the myArray array.`;
output.textContent = "";
...
for (let i = 0; i < myArray.length; i ++ ) {
    ...
    if (Array.isArray(myArray[i])) {
        // We have ana rray! So let's build a loop
